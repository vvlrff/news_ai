...
class Clussifier():
    ...
    def crate_xlsx(self, dictionary):
        ...
        df = df[['Название категории', 'Общее количество', 'Количество без дубликатов']]
    ...
    def main(self, target):
        answer = {'Спорт': {'Общее количество': 0, 'Количество без дубликатов': 0, 'Сообщения': []},
                  ...
                  'Шоубизнес': {'Общее количество': 0, 'Количество без дубликатов': 0,'Сообщения': []},
                  'Мода': {'Общее количество': 0, 'Количество без дубликатов': 0,'Сообщения': []},
                  'Криптовалюта': {'Общее количество': 0, 'Количество без дубликатов': 0,'Сообщения': []},
                  'Путешествия': {'Общее количество': 0, 'Количество без дубликатов': 0,'Сообщения': []},
                  'Образование': {'Общее количество': 0, 'Количество без дубликатов': 0,'Сообщения': []},
                  'Развлечения': {'Общее количество': 0, 'Количество без дубликатов': 0,'Сообщения': []},
                  'Общее': {'Общее количество': 0, 'Количество без дубликатов': 0,'Сообщения': []}}
