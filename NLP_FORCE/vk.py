...
def remove_links_and_hashtags(text):
    ...
    text_without_smileys = emoji.replace_emoji(text_without_n)
...
for key, value in cat_name.items():
    with open(f'NLP_FORCE\ForTrain4\{key}', mode='w', encoding='utf-8') as file:
