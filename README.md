...
## Обучение модели:
### Модель:   
Ссылка на скачивание модели: https://drive.google.com/drive/folders/1V_Uw9D60grLkRahNTjOXuBdIT-yB-Sne     
Путь к модели в репозитории: /server/src/api/weights/LaBSE_NaturaLP.pt
